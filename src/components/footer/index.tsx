...
export default function Footer() {
  return (
    <footer className="bg-silver dark:bg-black/30" aria-labelledby="footer-heading">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <div className="flex flex-col gap-1">
              {" "}
              <Paragraph type="para-3" className="text-base dark:text-silver text-lightGrey">
                    ...
                    <li key={item.name}>
                      <Link href={item.href}>
                        <Paragraph
                          type="para-3"
                          weight="normal"
                          className="dark:text-silver text-lightGrey hover:text-blueGrey"
                        >
                          {item.name}
                        </Paragraph>
                      </Link>
              ...
              <div className="flex flex-row gap-2">
                <div className="relative">
                  <input
                    ...
                    name="search"
                    // onChange={() => ()												}}
                    className="focus:placeholder-primary block w-full py-2 pl-3 pr-10 text-para-3 font-normal bg-gray-200 dark:bg-secondary rounded-lg placeholder-darkGrey dark:placeholder-lightGrey caret-primary  placeholder:font-normal focus:text-darkGrey focus:outline-none focus:placeholder:text-darkGrey "
